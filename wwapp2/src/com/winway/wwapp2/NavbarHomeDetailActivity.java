...
import com.winway.wwapp2.BaseFragment.HttpPutAsyncTask;
...
public class NavbarHomeDetailActivity extends BaseFragment
{
	...
	private View initView(LayoutInflater inflater, ViewGroup container) {
		...
		/*View view = inflater.inflate(R.layout.actnavbarhomedetail, container, false);
		contentView=view;
	 ...
	 public void loadData(Object result)
	  {
   		...
   		JSONObject jsonObject=new JSONObject((String)result).getJSONObject("GetMSGDetailResult");
   		 txtTitle.setText(jsonObject.getString("MSG004"));
	         ...
	         Content.loadData(jsonObject.getString("MSG009"), "text/html; charset=UTF-8",null);
