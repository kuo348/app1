...
public class SalesListActivity extends BaseFragment implements OnPullDownListener, OnItemClickListener {
	private Context context ;
	private Bundle bundle;
	private View mView=null;
	private int ACTION_MESSAGE;
	private SalesListAdapter adapter2;
	...
	private TextView lb_cancel;
	   ...
	   private void closeFragment() {
		...
		private View initView(LayoutInflater inflater, ViewGroup container) {
			View view = inflater.inflate(R.layout.actsaleslist, container, false);
		...
		/*
			...
			//adapter2 = new SimpleAdapter(context,mStrings,R.layout.pulldown_item,new String[]{"title","content"},new int[] {R.id.msg_title2,R.id.msg_content} );
			 ...
			 adapter2 = new SalesListAdapter(context,salesItems);
		...
		private void queryData(int Message)
		{
					 String json="";		
					   //  String url="http://59.125.146.7:8080/APQPService/GetMsgList?USERID=mis&PAGE="+Integer.toString(page)+"&WWID=13145774WWGlobal999988msg";
						 ...
						 if(!bundle.getString("func_name").equals(null))
					     {
							 url=super.getWebServiceUrl()+bundle.getString("func_name");
					     }
		...
		try {
				...
				for(int i=0;i<array.length() ;i++){
					...
					salesItems.add(new SalesItem(obj.getString("YD001"),obj.getString("YD002")));	
    		      }
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
					long id) {
		 final SalesItem item = (SalesItem ) salesItems.get(position);
